...
temperatur['Assam']=90;
temperatur['Grüntee']=80;
temperatur['Früchtetee']=100;
temperatur['Kräutertee']=90;
temperatur['Weißtee']=85;
...
//myApp.onPageInit ('index-3', function(e) {
	...
	for (k in teesorte) {
		...
		myApp.smartSelectAddOption('.smart-select #teesorte', '<option>'+k+'</option>');
...
$$('#teesortes').on('change', function (e) {
	...
	$$('#zeit').prop('value',teesorte[teesortex]);
	
	$$('#ziehzeit').html('Ziehzeit: '+teesorte[teesortex]+' Minuten');
	
	$$('#temperatur').html('Wassertemperatur: '+temperatur[teesortex]+'°C');
